    ...
    products.forEach(product => {
      ...
      productElement.innerHTML = `
       <img class="profilepicture" src="${product.profilepicture}" alt="${product.name}" style="width: 35px;height: 35px;object-fit: cover;object-position: top;border-radius: 3px;">
        ...
        <a <button="" href="${product.imageurl} type=" button"="" style="text-decoration: none;color: white;text-align: center;display: flow-root;width: -moz-available;padding-right: ;border-radius: 10px;">
           <img alt="Image" style="margin-top: 10px;width: inherit;border-radius: 10px;object-fit: cover;" src="${product.image} "></a>
